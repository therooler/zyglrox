...
def graph_J1J2_8(boundary_condition='open'):
    if boundary_condition == 'open':
        model_graph = {0: [[0,1], [0,2]], 1: [[1,0], [1,2], [1,3]],
                       2: [[2,0], [2,1], [2,3], [2,4]], 3: [[3,1], [3,2], [3,4], [3,5]],
                       4: [[4,2], [4,3], [4,5], [4,6]], 5: [[5,3], [5,4], [5,6], [5,7]],
                       6: [[6,4], [6,5], [6,7]], 7:[[7,5], [7,6]]}
        return model_graph
    elif boundary_condition == 'closed':
        model_graph = {0: [[0,1], [0,2]] + [[0,6], [0,7]], 1: [[1,0], [1,2], [1,3]] + [[1,7]],
                       2: [[2,0], [2,1], [2,3], [2,4]], 3: [[3,1], [3,2], [3,4], [3,5]],
                       4: [[4,2], [4,3], [4,5], [4,6]], 5: [[5,3], [5,4], [5,6], [5,7]],
                       6: [[6,4], [6,5], [6,7]] + [[6,0]], 7:[[7,5], [7,6]] + [[7,1], [7,0]]}
        return model_graph

def graph_J1J2_10(boundary_condition='open'):
    if boundary_condition == 'open':
        model_graph = {0: [[0,1], [0,2]], 1: [[1,0], [1,2], [1,3]],
                       2: [[2,0], [2,1], [2,3], [2,4]], 3: [[3,1], [3,2], [3,4], [3,5]],
                       4: [[4,2], [4,3], [4,5], [4,6]], 5: [[5,3], [5,4], [5,6], [5,7]],
                       6: [[6,4], [6,5], [6,7], [6,8]], 7: [[7,5], [7,6], [7,8], [7,9]],
                       8: [[8,6], [8,7], [8,9]], 9: [[9,7], [9,8]]}
        return model_graph
    elif boundary_condition == 'closed':
        model_graph = {0: [[0,1], [0,2]] + [[0,8], [0,9]], 1: [[1,0], [1,2], [1,3]] + [[1,9]],
                       2: [[2,0], [2,1], [2,3], [2,4]], 3: [[3,1], [3,2], [3,4], [3,5]],
                       4: [[4,2], [4,3], [4,5], [4,6]], 5: [[5,3], [5,4], [5,6], [5,7]],
                       6: [[6,4], [6,5], [6,7], [6,8]], 7: [[7,5], [7,6], [7,8], [7,9]],
                       8: [[8,6], [8,7], [8,9]] + [[8,0]], 9: [[9,7], [9,8]] + [[9,1], [9,0]]}
        return model_graph

def graph_J1J2_12(boundary_condition='open'):
    if boundary_condition == 'open':
        model_graph = {0: [[0,1], [0,2]], 1: [[1,0], [1,2], [1,3]],
                       2: [[2,0], [2,1], [2,3], [2,4]], 3: [[3,1], [3,2], [3,4], [3,5]],
                       4: [[4,2], [4,3], [4,5], [4,6]], 5: [[5,3], [5,4], [5,6], [5,7]],
                       6: [[6,4], [6,5], [6,7], [6,8]], 7: [[7,5], [7,6], [7,8], [7,9]],
                       8: [[8,6], [8,7], [8,9], [8,10]], 9: [[9,7], [9,8], [9,10], [9,11]],
                       10: [[10,8], [10,9], [10,11]], 11: [[11,9], [11,10]]}
        return model_graph
    elif boundary_condition == 'closed':
        model_graph = {0: [[0,1], [0,2]] + [[0,10], [0,11]], 1: [[1,0], [1,2], [1,3]] + [[1,11]],
                       2: [[2,0], [2,1], [2,3], [2,4]], 3: [[3,1], [3,2], [3,4], [3,5]],
                       4: [[4,2], [4,3], [4,5], [4,6]], 5: [[5,3], [5,4], [5,6], [5,7]],
                       8: [[8,6], [8,7], [8,9], [8,10]], 9: [[9,7], [9,8], [9,10], [9,11]],
                       10: [[10,8], [10,9], [10,11]] + [[10,0]], 11: [[11,9], [11,10]] + [[11,1], [11,0]]}
        return model_graph